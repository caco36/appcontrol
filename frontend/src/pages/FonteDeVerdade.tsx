        ...
        <div className="lg:col-span-7 bg-[#1a1a1a] border border-[#2a2a2a] p-8 rounded-2xl space-y-6 shadow-xl flex flex-col h-full min-h-[600px]">
          <div className="flex items-center justify-between border-b border-[#2a2a2a] pb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={() => projetoAtivo && downloadMarkdown('fonte-de-verdade', projetoAtivo.nome, markdownGerado)}
                className="px-4 py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider flex items-center gap-2 transition-all border border-[#e8ff5a]/30 text-[#e8ff5a] bg-[#e8ff5a]/10 hover:bg-[#e8ff5a] hover:text-[#0d0d0d] cursor-pointer"
              >
